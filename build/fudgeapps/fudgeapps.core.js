...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='fudgeapps']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"fudgeapps","hydrated",[["fudge-hex-editor","fudge-hex-editor",1,[["acceptFile",32],["asciiInline",1,0,"ascii-inline",4],["bytesPerGroup",1,0,"bytes-per-group",8],["bytesPerLine",1,0,"bytes-per-line",8],["bytesUntilForcedLine",1,0,"bytes-until-forced-line",8],["cursor",16],["displayAscii",1,0,"display-ascii",4],["editType",1,0,"edit-type",2],["file",16],["fileMetadata",16],["lineNumber",16],["maxLines",1,0,"max-lines",8],["mode",1,0,1,2],["regionDepth",1,0,"region-depth",8],["regions",1],["saveFile",32],["selection",16],["setCursorPosition",32],["setLineNumber",32],["setSelection",32]]],["fudge-hex-tooltip","fudge-hex-tooltip",1,[["active",1,0,1,4],["data",1,0,"complex",2],["simpleText",1,0,"simple",2]]]]);